...
g++ -shared -Wall -std=c++11 -I.\include\ .\src\GtkGreeter\GtkGreeter.cpp -o .\bin\Greeter.dll
g++ -shared -Wall -std=c++11 -I.\include\ .\src\MessengerMercadoLibre\MessengerMercadoLibre.cpp -o .\bin\Messenger.dll